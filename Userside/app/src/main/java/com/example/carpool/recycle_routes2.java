...
public class recycle_routes2 extends AppCompatActivity {
    private Scheduleviewmodel mschedviewmodel;
    RecyclerView recyclerview;
    @Override
    public void onCreate( Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recycleroute2);
        ...
        mschedviewmodel.getAllschedule_r().observe(this, new Observer<List<schedule>>() {
                    @Override
